...
Current Version
The current stable baseline is v0.5.2.
...
Current Milestone
The v0.5.2 milestone is complete.
Completed goals:
...
Rebalanced the Garage controls and visual summary columns for faster reading.
Standardized the live vehicle preview on a front-up orientation.
Replaced small armor bubbles with one large six-zone numeric readout strip.
Preserved independent axle tire graphics and independent directional armor graphics.
Updated replay metadata, page branding, README, changelog, and technical documentation to v0.5.2.
